...
import { ContainerFooterAdmin } from "./footerAdminStyled";


export default function FooterAdmin() {
  return (
    <ContainerFooterAdmin>
      <footer className="block py-4">
        <div className="container mx-auto px-4">
          <div className="container-footer flex flex-wrap items-center md:justify-between justify-center">
